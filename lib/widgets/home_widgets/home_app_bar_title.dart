...
class HomeAppBarTitle extends StatelessWidget {
  ...
  final VoidCallback? onDiscountsTap;
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        _DiscountsButton(onTap: onDiscountsTap),
        const SizedBox(width: 8),
            ...
            children: [
              Text(
                displayName == null
                    ...
                    : context.trArgs('مرحباً {name}', {'name': displayName}),
              ...
              Text(
                context.tr('ماذا تريد أن تطلب اليوم؟'),
...
class _DiscountsButton extends StatelessWidget {
  final VoidCallback? onTap;

  const _DiscountsButton({this.onTap});
